...
/* SVGR has dropped some elements not supported by react-native-svg: d:SVGTestCase, title, fontFace, a, view */
const SvgLinkingUri01B = (props) => (
  <Svg
    baseProfile="basic"
    id="svg-root"
    width="100%"
    ...
    >
      ...
      <G fontSize={14}>
        <G transform="translate(-150,75)">
          ...
          <Text x={315} y={152} fontSize={12}>
            {"Click element's line"}
          </Text>
          <Text x={315} y={164} fontSize={12}>
            {"to link to its view"}
          </Text>
        </G>
        <Rect
...
export default SvgLinkingUri01B;
