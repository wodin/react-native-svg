...
const SvgFontsElem01T = (props) => (
  ...
  >
    ...
    >
      <Defs></Defs>
      <Text fill="black" stroke="none" fontSize={35} x={56} y={35}>
        {"Basic SVG font element"}
      </Text>
      <G fill="black" stroke="none">
        <Text x={30} y={130} fontSize={18}>
          {"Placed Glyphs"}
        </Text>
...
export default SvgFontsElem01T;
