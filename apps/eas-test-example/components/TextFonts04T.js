...
const SvgTextFonts04T = (props) => (
  ...
  >
    ...
    <G id="test-body-content" fontSize={18}>
      ...
      <Text x={340} y={60} fontFamily="Haettenschweiler" fontSize={35}>
        {"ABC"}
      </Text>
      <Text
        x={15}
      ...
      <Text x={340} y={110} fontFamily="Charlesworth" fontSize={35}>
        {"ABC"}
      </Text>
      <Text
        x={15}
...
export default SvgTextFonts04T;
