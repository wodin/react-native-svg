...
const SvgFiltersImage01B = (props) => (
  <Svg
    baseProfile="basic"
    id="svg-root"
    width="100%"
  ...
  >
    ...
    >
      <Defs></Defs>
      <Text fontFamily="Arial" fontSize={12} x={240} y={20} textAnchor="middle">
        {"Basic test of feImage filter support."}
      </Text>
...
export default SvgFiltersImage01B;
