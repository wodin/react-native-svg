...
const SvgFontsElem04B = (props) => (
  ...
  >
    ...
    >
      <Defs></Defs>
      <Text fill="black" stroke="none" fontSize={30} x={26} y={35}>
        {"External SVG font element (css)"}
      </Text>
      <G fill="black" stroke="none">
        <Text x={31} y={130} fontSize={18}>
          {"Placed Glyphs"}
        </Text>
        <G transform="translate(165,140) scale(1, -1)">
          ...
          <G transform="scale(0.029296875)">
            ...
            <Path
              ...
              d="M1011 892L665 144Q537 -129 469 -313L403 -507Q377 -579 313 -579Q271 -579 241 -552T210 -483Q210 -383 426 96L68 785L23 858Q-4 904 -4 935Q-4 976 27 1007T98 1038Q144 1038 169 1003Q339 767 534 331L682 676Q762 855 836 984Q868 1040 920 1040Q961 1040 992 1011T1024 942Q1024 920 1011 892z"
            />
            <Line
              x1={2564}
              y1={-3500}
      ...
      <Text x={67} y={210} fontSize={18}>
        {"SVG Font"}
      </Text>
      <G
        transform="translate(165, 220)"
        fontFamily="TestComic"
        fontSize={60}
        fill="black"
        stroke="none"
      >
        <Line x1={0} y1={0} x2={210} y2={0} strokeWidth={1} stroke="#888888" />
        <Text>{"Ay\xD6@\xE7"}</Text>
      </G>
    </G>
...
export default SvgFontsElem04B;
